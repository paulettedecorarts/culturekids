...
class LanguageActivityManager extends Component
{
        ...
        return LanguageActivity::query()
            ...
            ->when($this->search !== '', fn ($q) => $q->where(function ($inner) {
                $inner->where('title', 'like', '%'.$this->search.'%')
                      ...
                      ->orWhere('language_code', 'like', '%'.$this->search.'%');
            }))
            ->when($this->typeFilter !== '', fn ($q) => $q->where('activity_type', $this->typeFilter))
    ...
    {
        return view('livewire.cms.languages.language-activity-manager', [
