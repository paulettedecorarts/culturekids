...
use App\Livewire\CMS\Culture\CultureActivityShow;
use App\Livewire\CMS\Drawings\DrawingShow;
use App\Livewire\CMS\Games\GameShow;
use App\Livewire\CMS\Languages\LanguageActivityShow;
use App\Livewire\CMS\Mazes\MazeShow;
...
use App\Livewire\CMS\SpotDifferences\SpotDifferenceShow;
use App\Livewire\CMS\WordSearches\WordSearchShow;
...
Route::middleware(['auth', 'verified', 'role:org_admin', 'portal.role:org_admin'])->prefix('cms/admin')->name('cms.admin.')->group(function () {
    ...
    Route::get('/approved-content/spot-differences/{id}', SpotDifferenceShow::class)->name('approved-content.spot-differences.show');
    Route::get('/approved-content/word-searches/{id}', WordSearchShow::class)->name('approved-content.word-searches.show');
    Route::get('/approved-content/culture-activities/{id}', CultureActivityShow::class)->name('approved-content.culture-activities.show');
