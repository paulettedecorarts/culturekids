<div>
    ...
    @endif
    <div class="cms-stats-row" style="grid-template-columns:repeat(3, 1fr);">
        <div class="cms-stat"><div class="cms-stat-val">{{ $totalUsers }}</div><div class="cms-stat-label">Total Users</div></div>
