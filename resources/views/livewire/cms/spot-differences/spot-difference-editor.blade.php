<div class="sd-editor-page">
    <style>
    .sd-editor-page .sd-card { background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);border-radius:12px;padding:24px;margin-bottom:20px; }
    .sd-editor-page .sd-title { font-size:11px;font-weight:700;color:rgba(255,255,255,.5);text-transform:uppercase;letter-spacing:.6px;margin-bottom:18px; }
    .sd-editor-page .sd-label { display:block;font-size:11px;font-weight:600;color:rgba(255,255,255,.6);text-transform:uppercase;letter-spacing:.4px;margin-bottom:6px; }
    .sd-editor-page .sd-input { display:block;width:100%;box-sizing:border-box;padding:9px 12px;border-radius:8px;border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.05);color:#fff;font-size:13px;font-family:var(--font-admin,inherit);transition:border-color .2s; }
    .sd-editor-page .sd-input:focus { outline:none;border-color:rgba(212,160,23,.6);background:rgba(255,255,255,.07); }
    .sd-editor-page .sd-input::placeholder { color:rgba(255,255,255,.3); }
    .sd-editor-page select.sd-input { background:#1a2744;color:#fff;color-scheme:dark; }
    .sd-editor-page select.sd-input option { background:#1a2744;color:#fff; }
    ...
    .sd-image-wrapper img { display:block;max-width:100%;border-radius:8px;border:1px solid rgba(255,255,255,.1); }
    ...
    <form wire:submit="save">
        ...
        <div class="sd-card">
            ...
            <div class="sd-grid-4">
                ...
                <div class="sd-field">
                    <label class="sd-label">Tribe <span style="color:#ff8c8c">*</span></label>
                    <select wire:model="tribe_id" class="sd-input" required>
            ...
            <div class="sd-grid-5">
                <div class="sd-field">
                    ...
                    <input wire:model="age_min" type="number" class="sd-input" min="1" max="18">
                    @error('age_min') <div class="sd-error">{{ $message }}</div> @enderror
                </div>
                <div class="sd-field">
                    <label class="sd-label">Max Age</label>
                    <input wire:model="age_max" type="number" class="sd-input" min="1" max="18">
                    @error('age_max') <div class="sd-error">{{ $message }}</div> @enderror
                </div>
                <div class="sd-field">
                    <label class="sd-label">Star Points</label>
                    <input wire:model="star_points" type="number" class="sd-input" min="1" max="100">
                </div>
                <div class="sd-field">
            ...
            <div class="sd-grid-2">
                ...
                <div class="sd-field">
                    <label class="sd-label">Cultural Note <span style="color:rgba(255,255,255,.35);font-weight:400;text-transform:none;font-size:10px">optional</span></label>
        ...
        <div class="sd-card">
            ...
            <div class="sd-grid-2">
                <div class="sd-field">
                    <label class="sd-label">Image A — Original <span style="color:rgba(255,255,255,.35);font-weight:400;text-transform:none;font-size:10px">max 10MB</span></label>
                    ...
                    @if($activity && $activity->image_a_path)
                        <img src="{{ asset('storage/' . $activity->image_a_path) }}" style="margin-top:8px;max-width:100%;border-radius:6px;border:1px solid rgba(255,255,255,.1)">
                    @endif
                </div>
                <div class="sd-field">
                    <label class="sd-label">Image B — With Differences <span style="color:rgba(255,255,255,.35);font-weight:400;text-transform:none;font-size:10px">max 10MB</span></label>
                    ...
                    @if($activity && $activity->image_b_path)
                        <img src="{{ asset('storage/' . $activity->image_b_path) }}" style="margin-top:8px;max-width:100%;border-radius:6px;border:1px solid rgba(255,255,255,.1)">
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="sd-card"
            ...
            <div style="margin-bottom:20px">
                <div style="font-size:11px;color:rgba(255,255,255,.5);margin-bottom:8px">
            ...
            @else
            <div style="padding:32px;text-align:center;color:rgba(255,255,255,.35);font-size:12px;border:1px dashed rgba(255,255,255,.1);border-radius:8px;margin-bottom:20px">
            ...
            <div style="display:grid;grid-template-columns:32px 1fr 1fr 1fr 1fr auto;gap:10px;align-items:center;padding:8px 12px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);border-radius:8px;margin-bottom:6px">
                ...
                <div style="font-size:11px;color:rgba(255,255,255,.5)">X: {{ $zone['x_percent'] }}%</div>
                <div style="font-size:11px;color:rgba(255,255,255,.5)">Y: {{ $zone['y_percent'] }}%</div>
                <div style="font-size:11px;color:rgba(255,255,255,.5)">R: {{ $zone['radius_percent'] }}%</div>
                <button type="button" wire:click="removeZone({{ $i }})" style="background:none;border:none;color:rgba(255,255,255,.4);cursor:pointer;font-size:18px;padding:0 4px">×</button>
            </div>
            @empty
            <div style="padding:20px;text-align:center;color:rgba(255,255,255,.35);font-size:12px;border:1px dashed rgba(255,255,255,.1);border-radius:8px">
