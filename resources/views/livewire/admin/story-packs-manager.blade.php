<div>
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:var(--sp-5);flex-wrap:wrap;gap:var(--sp-3)">
        ...
        <div style="display:flex;gap:var(--sp-2);align-items:center">
            ...
            <button class="btn btn-primary btn-sm" style="background:var(--clay-red); border:none; color:var(--cms-text); padding: var(--sp-2) var(--sp-4); border-radius: var(--r-full); font-weight:700; cursor:pointer;">+ Add Story</button>
        </div>
    </div>
    ...
    <div style="display:flex;gap:var(--sp-3);margin-bottom:var(--sp-4);flex-wrap:wrap">
        <input placeholder="🔍 Search stories…" style="padding:8px 14px;border-radius:var(--r-full);border:1px solid var(--cms-input-border);background:var(--cms-input-bg);color:var(--cms-text);font-family:var(--font-admin);font-size:12px;outline:none;flex:1;min-width:180px">
        <select style="padding:8px 14px;border-radius:var(--r-full);border:1px solid var(--cms-input-border);background:var(--cms-input-bg);color:var(--cms-text);font-family:var(--font-admin);font-size:12px;outline:none">
    ...
    <div class="sa-table-wrap">
        ...
        <div class="sa-table-row" style="grid-template-columns:2.5fr 1fr 1fr 1fr 100px 140px">
            <div style="display:flex;align-items:center;gap:12px">
                ...
                <div>
                    <div style="font-weight:600;color:var(--cms-text);font-size:13px">The Clever Hare</div>
                    <div style="font-size:11px;color:var(--cms-text-muted)">12 panels · id-001</div>
                </div>
            </div>
            <span style="font-size:12px;color:var(--cms-text-muted)">Buganda</span>
        ...
        <div class="sa-table-row" style="grid-template-columns:2.5fr 1fr 1fr 1fr 100px 140px">
            <div style="display:flex;align-items:center;gap:12px">
                ...
                <div>
                    <div style="font-weight:600;color:var(--cms-text);font-size:13px">Garden Words</div>
                    <div style="font-size:11px;color:var(--cms-text-muted)">8 panels · id-002</div>
                </div>
            </div>
            <span style="font-size:12px;color:var(--cms-text-muted)">Acholi</span>
