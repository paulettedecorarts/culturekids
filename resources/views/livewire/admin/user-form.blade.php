<div class="sa-user-form-view">
    ...
    <div style="display:grid; grid-template-columns:1fr 400px; gap:32px; align-items:start">
        ...
        <div style="display:flex; flex-direction:column; gap:32px">
            ...
            <div style="background:rgba(196,75,43,0.05); border:1px solid rgba(196,75,43,0.1); border-radius:32px; padding:40px">
                <h3 style="font-family:var(--font-display); font-size:20px; color:var(--clay-red-light); margin-bottom:16px">Platform Safety Protocol</h3>
                <p style="font-size:13px; color:rgba(255,255,255,0.5); line-height:1.6; margin-bottom:0">All user account modifications are audited. Ensure role assignments comply with the platform's RBAC matrix and institutional data isolation standards. Revoking permissions will take effect upon the user's next synchronization.</p>
            </div>
        </div>

        <!-- Sidebar Panel: Rights & Association -->
        <div style="display:flex; flex-direction:column; gap:32px">
            <div style="background:rgba(255,255,255,.04); border:1px solid rgba(255,255,255,0.08); border-radius:32px; padding:40px">
                <h3 style="font-family:var(--font-display); font-size:20px; color:#fff; margin-bottom:24px">Institutional Binding</h3>
            ...
            <div style="background:rgba(255,255,255,.04); border:1px solid rgba(255,255,255,0.08); border-radius:32px; padding:40px">
                <h3 style="font-family:var(--font-display); font-size:20px; color:#fff; margin-bottom:24px">RBAC Privileges</h3>
