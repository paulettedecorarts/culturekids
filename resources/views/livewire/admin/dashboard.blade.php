            ...
            <div class="sa-table-row" style="grid-template-columns:2fr 1fr 1fr 1fr 100px">
                <div style="display:flex;align-items:center;gap:var(--sp-2)">
                    ...
                    <div>
                        ...
                        <div style="font-size:10px;color:var(--cms-text-muted)">{{ $org->slug }}.paulette.app</div>
                    </div>
                </div>
                ...
                <button class="btn btn-sm" style="background:var(--cms-surface-hover);color:var(--cms-text-muted);padding:3px 8px;font-size:9px" onclick="toast('Managing {{ $org->name }}…')">
                    Manage
                </button>
            </div>
        @empty
