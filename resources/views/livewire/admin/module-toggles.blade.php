<div>
    ...
    @else
        <div style="text-align:center;padding:var(--sp-12);color:rgba(255,255,255,.3)">
            ...
            <a href="{{ route('admin.modules-registry') }}" style="display:inline-block;background:var(--clay-red);color:#fff;padding:12px 24px;border-radius:14px;text-decoration:none;font-weight:700;font-size:13px">
