            ...
            <div style="background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);border-radius:var(--r-xl);padding:var(--sp-5)">
                <div style="display:flex;align-items:center;gap:var(--sp-4);margin-bottom:var(--sp-4);flex-wrap:wrap">
                    ...
                    <div style="display:flex;gap:var(--sp-2);flex-wrap:wrap">
                        <button type="button" wire:click="edit({{ $org->id }})" class="btn btn-sm" style="background:rgba(255,255,255,.06); color:rgba(255,255,255,.85); border:1px solid rgba(255,255,255,.12); font-size:10px">Quick edit</button>
                ...
                <div style="display:flex;gap:var(--sp-6);font-size:12px;color:rgba(255,255,255,.5);flex-wrap:wrap">
        ...
        <div style="position:fixed; inset:0; background:rgba(0,0,0,0.8); backdrop-filter:blur(10px); z-index:1000; display:flex; align-items:center; justify-content:center; padding:40px">
            <div style="background:var(--indigo-night); width:100%; max-width:600px; border:1px solid rgba(255,255,255,0.15); border-radius:32px; box-shadow:0 40px 100px rgba(0,0,0,0.5); overflow:hidden" onclick="event.stopPropagation()">
                <div style="padding:32px; border-bottom:1px solid rgba(255,255,255,0.1); display:flex; align-items:center; justify-content:space-between">
                    <div>
                        <h2 style="font-family:var(--font-display); font-size:24px; color:#fff">Configure entity</h2>
                        <div style="font-size:11px; color:rgba(255,255,255,0.4); text-transform:uppercase; font-weight:800; letter-spacing:1px">Update system parameters</div>
                    </div>
                    <button type="button" wire:click="$set('showModal', false)" style="background:none; border:none; color:#fff; font-size:24px; cursor:pointer">&times;</button>
                </div>
                ...
                <form wire:submit.prevent="save" style="padding:32px; display:grid; grid-template-columns:1fr 1fr; gap:20px">
                    <div style="grid-column: span 2">
                        ...
                        <div style="display:flex; align-items:center; gap:20px">
                            ...
                            <input type="file" wire:model="logo" accept="image/*" style="font-size:11px; color:rgba(255,255,255,0.4)">
                        </div>
                    ...
                    <div style="grid-column: span 2">
                        ...
                        <input wire:model="name" type="text" style="width:100%; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); border-radius:12px; padding:14px; color:#fff; font-family:var(--font-admin)">
                    ...
                    <div style="grid-column: span 2">
                        ...
                        <select wire:model="plan" style="width:100%; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); border-radius:12px; padding:14px; color:#fff">
