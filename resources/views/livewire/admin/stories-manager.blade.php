<div>
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:var(--sp-3);margin-bottom:var(--sp-5)">
        <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:20px">
            <div style="font-size:28px;font-weight:800;color:#fff;margin-bottom:4px">{{ $stats['total'] }}</div>
            <div style="font-size:11px;color:rgba(255,255,255,0.4);font-weight:700;text-transform:uppercase">Total Stories</div>
        </div>
        <div style="background:rgba(74,124,89,0.1);border:1px solid rgba(74,124,89,0.2);border-radius:16px;padding:20px">
            ...
            <div style="font-size:11px;color:rgba(255,255,255,0.4);font-weight:700;text-transform:uppercase">Published</div>
        </div>
        <div style="background:rgba(212,160,23,0.1);border:1px solid rgba(212,160,23,0.2);border-radius:16px;padding:20px">
            ...
            <div style="font-size:11px;color:rgba(255,255,255,0.4);font-weight:700;text-transform:uppercase">Draft</div>
        </div>
        <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:20px">
            <div style="font-size:28px;font-weight:800;color:#fff;margin-bottom:4px">{{ $tribes->count() }}</div>
            <div style="font-size:11px;color:rgba(255,255,255,0.4);font-weight:700;text-transform:uppercase">Tribes</div>
        </div>
    </div>

    <!-- Filters -->
    <div style="display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:var(--sp-3);margin-bottom:var(--sp-5)">
        <input wire:model.live="searchTerm" type="text" placeholder="🔍 Search stories..." style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:12px 16px;color:#fff;font-size:13px;outline:none">

        <select wire:model.live="filterTribe" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:12px 16px;color:#fff;font-size:13px;outline:none;cursor:pointer">
        ...
        <select wire:model.live="filterStatus" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:12px 16px;color:#fff;font-size:13px;outline:none;cursor:pointer">
        ...
        <select wire:model.live="filterAgeRange" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:12px 16px;color:#fff;font-size:13px;outline:none;cursor:pointer">
            ...
            <div style="background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);border-radius:var(--r-xl);overflow:hidden;transition:all 0.3s" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 8px 32px rgba(0,0,0,0.3)'" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='none'">
                <div style="height:180px;background:linear-gradient(135deg, rgba(196,75,43,0.3), rgba(107,32,16,0.3));display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden">
                    ...
                    @if($story->status === 'published')
                        <span style="position:absolute;top:12px;right:12px;background:rgba(74,124,89,0.9);color:#fff;padding:4px 12px;border-radius:20px;font-size:10px;font-weight:800">PUBLISHED</span>
                    @elseif($story->status === 'review')
                        <span style="position:absolute;top:12px;right:12px;background:rgba(232,135,42,0.9);color:#fff;padding:4px 12px;border-radius:20px;font-size:10px;font-weight:800">IN REVIEW</span>
                    @else
                        <span style="position:absolute;top:12px;right:12px;background:rgba(212,160,23,0.9);color:#fff;padding:4px 12px;border-radius:20px;font-size:10px;font-weight:800">DRAFT</span>
                    @endif
                </div>
                ...
                <div style="padding:var(--sp-4)">
                    <div style="display:flex;align-items:start;justify-content:space-between;margin-bottom:var(--sp-2)">
                        <div style="flex:1">
                            ...
                            <div style="font-size:11px;color:rgba(255,255,255,.4);font-weight:700">
                    ...
                    @if($story->description)
                        <p style="font-size:12px;color:rgba(255,255,255,.5);margin-bottom:var(--sp-3);line-height:1.5;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden">
                            {{ $story->description }}
                        </p>
                    @endif
