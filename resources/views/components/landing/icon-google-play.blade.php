{{-- Google Play 2022 icon (official Wikimedia / Google brand) --}}
<svg class="landing-store-icon landing-store-icon--google-play" viewBox="0 0 28.99 31.99" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
